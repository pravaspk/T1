...
Model.findByemail = function findByemail(email, projection, options, callback) {
  _checkContext(this, 'findByemail');
  ...
  return this.findOne({ email: email }, projection, options, callback);
};
Model.findBynumber = function findBynumber(number, projection, options, callback) {
  _checkContext(this, 'findBynumber');
  ...
  return this.findOne({ number: number }, projection, options, callback);
};
